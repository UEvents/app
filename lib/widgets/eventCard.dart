            ...
            children: <Widget>[
                  ...
                  children: <Widget>[
                      Row(children: <Widget>[ //location
                        ...
                        Padding(
                            ...
                            child: Text(eventData.address, style: TextStyle(fontSize: 14, fontFamily: 'Roboto',
              ...
              Container( //card body
                ...
                child: Column(children: <Widget>[
                  Container(
                    child: Text(eventData.title, style: TextStyle(fontSize: 20),),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Flexible(        
                          child: Container(
                            child: Text(eventData.shortDescription, textAlign: TextAlign.left,)
                          ),
                        )
                    ]),
                  ),
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(55))),
                          child: FlatButton( 
                            onPressed: (){},
